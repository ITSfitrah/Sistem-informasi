                ...
                <div class="container-fluid">
                    ...
                    <div class="content">
                        ...
                        <div class="form-login">
                            <form action="{{ url('/barang/update/' . $barang->id_barang) }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="id_barang" id="id_barang"
                                        placeholder="Masukkan ID Barang" value="{{ $barang->id_barang }}" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="jumlah_stock" id="jumlah_stock"
                                        placeholder="Masukkan Jumlah Stock" value="{{ $barang->jumlah_stock }}" />
                                </div>
                                <div class="form-group">
