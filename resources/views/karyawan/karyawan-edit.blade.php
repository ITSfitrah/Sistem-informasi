...
<body id="page-top">
    ...
    <!-- script dropdown user information -->
    <script>
                ...
                <div class="container-fluid">
                    ...
                    <div class="content">
                        ...
                        <div class="form-login">
                            <form action="{{ url('/karyawan/update/' . $karyawan->id_karyawan) }}" method="post"
                                enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                    <label for="id_karyawan">ID KARYAWAN</label>
                                    <input class="form-control" type="text" name="id_karyawan" id="id_karyawan"
                                        placeholder="Masukkan ID Karyawan" value="{{ $karyawan->id_karyawan }}" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="alamat" id="alamat"
                                        placeholder="Masukkan Alamat" value="{{ $karyawan->alamat }}" />
                                </div>
                                <div class="form-group">
