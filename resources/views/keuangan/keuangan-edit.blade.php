                ...
                <div class="container-fluid">
                    ...
                    <div class="content">
                        ...
                        <div class="form-login">
                            <form action="{{ url('/keuangan/update/' . $keuangan->id_keuangan) }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="id_keuangan" id="id_keuangan"
                                        placeholder="Masukkan ID Keuangan" value="{{ $keuangan->id_keuangan }}" />
                                </div>
                                <div class="form-group">
                                <label for="id_penjualan">PILIH ID PENJUALAN</label>
                                <select class="form-control" name="id_penjualan" id="id_penjualan" >
                                    <option value="{{ $keuangan->id_penjualan }}">Pilih ID Barang</option>
                                    <?php
// Koneksi ke database 
...
$query = "SELECT id_penjualan, id_penjualan FROM barang";
        ...
        ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="nama_perusahaan" id="nama_perusahaan"
                                        placeholder="Masukkan Nama Perusahaan" value="{{ $keuangan->nama_perusahaan }}" />
                                </div>
                                <div class="form-group">
                                    <label for="nama_barang">NAMA BARANG</label>
                                    <input class="form-control" type="text" name="nama_barang" id="nama_barang"
                                        placeholder="Masukkan Nama Barang" value="{{ $keuangan->nama_barang }}" />
                                </div>
                                <div class="form-group">
                                    <label for="no_telp">NOMOR TELEPON</label>
                                    <input class="form-control" type="text" name="no_telp" id="no_telp"
                                        placeholder="Masukkan Nomor Telepon" value="{{ $keuangan->no_telp }}" />
                                </div>
                                <div class="form-group">
