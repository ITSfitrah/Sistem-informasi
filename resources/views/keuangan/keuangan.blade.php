...
<style>
    ...
    .table-container {
        ...
        align-items: center;
        margin-bottom: 20px;
        /* Add some bottom margin to create space */
    }
</style>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                            ...
                            <tbody>
                                @foreach ($keuangan as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/keuangan/edit/{{ $data->id_keuangan }}">Edit</a>
                                            <a href="/keuangan/hapus/{{ $data->id_keuangan }}">Hapus</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                    ...
                    <div class="table-container">
                        ...
                        <a href="/keuangan/tambah" class="btn btn-primary btn-tambah">
                            <span class="icon-plus"></span> Tambah Data
                        </a>
                        <a href="/keuangan/cetak" class="btn btn-primary btn-tambah">
                            <span class="icon-print"></span> Cetak Laporan
                        </a>
                    </div>
                </div>
