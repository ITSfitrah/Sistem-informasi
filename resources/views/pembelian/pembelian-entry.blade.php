                    ...
                    <div class="form-login">
                        <form action="{{ url('/pembelian/store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="id_pembelian" id="id_pembelian"
                                    placeholder="Masukkan ID Pembelian" required />
                            </div>

                            <div class="form-group">
                                <label for="id_supplier">PILIH ID SUPPLIYER</label>
...
$query = "SELECT id_supplier, id_supplier FROM supplier";
...
while ($row = mysqli_fetch_assoc($result)) {
    echo "<option value='" . $row['id_supplier'] . "'>" . $row['id_supplier'] . "</option>";
}
...
mysqli_close($koneksi);
        ?>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="total_biaya" id="total_biaya"
