            ...
            <div id="content">
                ...
                <div class="container-fluid">
                            ...
                            <tbody>
                                @foreach ($pembelian as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/pembelian/edit/{{ $data->id_pembelian }}">Edit</a>
                                            <a href="/pembelian/hapus/{{ $data->id_pembelian }}">Hapus</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                    ...
                    <div class="table-container">
                        ...
                        <a href="/pembelian/tambah" class="btn btn-primary btn-tambah">
