                ...
                <div class="container-fluid">
                    ...
                    <div class="content">
                        ...
                        <div class="form-login">
                            <form action="{{ url('/penjualan/update/' . $penjualan->id_penjualan) }}" method="post"
                                enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                    <label for="id_penjualan">ID PENJUALAN</label>
                                    <input class="form-control" type="text" name="id_penjualan" id="id_penjualan"
                                        placeholder="Masukkan ID Penjualan" value="{{ $penjualan->id_penjualan }}" />
                                </div>
                                <div class="form-group">
                                <label for="id_karyawan">PILIH ID KARYAWAN</label>
                                <select class="form-control" name="id_karyawan" id="id_karyawan" >
                                    <option value="{{ $penjualan->id_karyawan }}">Pilih ID Karyawan</option>
                                    <?php
...
$query = "SELECT id_karyawan, id_karyawan FROM karyawan";
...
mysqli_close($koneksi);
        ?>
                            ...
                            <div class="form-group">
                                <label for="id_barang">PILIH ID BARANG</label>
                                <select class="form-control" name="id_barang" id="id_barang" >
                                    <option value="{{ $penjualan->id_barang }}">Pilih ID Barang</option>
                                    <?php
// Koneksi ke database (ganti dengan konfigurasi koneksi Anda)
$koneksi = mysqli_connect("localhost", "root", "", "si_penjualan");
...
// Query untuk mengambil data dari tabel barang (ganti nama_tabel dengan nama tabel yang sesuai)
$query = "SELECT id_barang, id_barang FROM barang";
        ...
        ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="jumlah" id="jumlah"
                                        placeholder="Masukkan Jumlah Barang" value="{{ $penjualan->jumlah }}" />
                                </div>
                                <div class="form-group">
                                    <label for="harga">HARGA SATUAN</label>
                                    <input class="form-control" type="text" name="harga" id="harga"
                                        placeholder="Masukkan Harga Satuan" value="{{ $penjualan->harga }}" />
                                </div>
                                <div class="form-group">
                                    <label for="total">TOTAL BELANJA</label>
                                    <input class="form-control" type="text" name="total" id="total"
                                        placeholder="Masukkan Total Belanja" value="{{ $penjualan->total }}" />
                                </div>
                                <div class="form-group">
