            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="form-login">
                        <form action="{{ url('/penjualan/store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="id_penjualan">ID PENJUALAN</label>
                                <input class="form-control" type="text" name="id_penjualan" id="id_supplier"
                                    placeholder="Masukkan ID Supplyer" required />
                            </div>
