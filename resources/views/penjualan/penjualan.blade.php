            ...
            <div id="content">
                ...
                <div class="container-fluid">
                            ...
                            <tbody>
                                @foreach ($penjualan as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->total }}</td>
                                        <td>
                                            <a href="/penjualan/edit/{{ $data->id_penjualan }}">Edit</a>
                                            <a href="/penjualan/hapus/{{ $data->id_penjualan }}">Hapus</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                    ...
                    <div class="table-container">
                        ...
                        <a href="/penjualan/tambah" class="btn btn-primary btn-tambah">
