                ...
                <div class="container-fluid">
                    ...
                    <div class="content">
                        ...
                        <div class="form-login">
                            <form action="{{ url('/supplier/update/' . $supplier->id_supplier) }}" method="post"
                                enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                    <label for="id_supplier">ID SUPPLIYER</label>
                                    <input class="form-control" type="text" name="id_supplier" id="id_supplier"
                                        placeholder="Masukkan ID Barang" value="{{ $supplier->id_supplier }}" />
                                </div>
                                <div class="form-group">
                                <label for="id_barang">PILIH ID BARANG</label>
                                <select class="form-control" name="id_barang" id="id_barang" >
                                    <option value="{{ $supplier->id_supplier }}">Pilih ID Barang</option>
                                    <?php
        ...
        ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="nama_perusahaan" id="nama_perusahaan"
                                        placeholder="Masukkan Nama Perusahaan" value="{{ $supplier->nama_perusahaan }}" />
                                </div>
                                <div class="form-group">
                                    <label for="nama_barang">NAMA BARANG</label>
                                    <input class="form-control" type="text" name="nama_barang" id="nama_barang"
                                        placeholder="Masukkan Nama Barang" value="{{ $supplier->nama_barang }}" />
                                </div>
                                <div class="form-group">
                                    <label for="no_telp">NOMOR TELEPON</label>
                                    <input class="form-control" type="text" name="no_telp" id="no_telp"
                                        placeholder="Masukkan Nomor Telepon" value="{{ $supplier->no_telp }}" />
                                </div>
                                <div class="form-group">
